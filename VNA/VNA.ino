...
#define IFCLOCK_PIN PB8
#define IFCLOCK_PORT2_PIN PB9
#define AD_CUR_PIN PA0
#define AD_VOLT_PIN PB0
#define AD_CUR2_PIN PA2
#define ATTEN_PIN PB1
#define TOUCHSCREEN_DISABLE_PIN PA3
...
{
  nvic_irq_set_priority(NVIC_EXTI_9_5, 2);
...
int opencalib_cmd(int args, tinycl_parameter* tp, void *v)
{
  ...
  switch (vna_opencalib())
  {
    case 0: console_println("Calibration aborted");
      return 1;
      break;
    case 1: console_println("Open calibration successful");
      break;
    case 2: console_println("1 Port calibration successful");
      break;
  }
  return 1;
}
...
int shortcalib_cmd(int args, tinycl_parameter* tp, void *v)
{
  ...
  switch (vna_shortcalib())
  {
    case 0: console_println("Calibration aborted");
      return 1;
      break;
    case 1: console_println("Short calibration successful");
      break;
    case 2: console_println("1 Port calibration successful");
      break;
  }
...
int loadcalib_cmd(int args, tinycl_parameter* tp, void *v)
{
  ...
  switch (vna_loadcalib())
  {
    case 0: console_println("Calibration aborted");
      return 1;
      break;
    case 1: console_println("Load calibration successful");
      break;
    case 2: console_println("1 Port calibration successful");
      break;
  }
...
int twocalib_cmd(int args, tinycl_parameter* tp, void *v)
{
  ...
  switch (vna_thrucal())
  {
    case 0: console_println("One Port Cal Must Be Performed Before Thru Cal");
      break;
    case 1: console_println("Calibration aborted");
      break;
    case 2:  console_println("Thru calibration successful");
      break;
  }
  return 1;
}
...
int vna_writecal(int n)
{
  ...
  vp[3] = &tcal;
  b[3] = sizeof(tcal);
  return writeflashstruct(n-1, 4, vp, b);
#else
  return writeflashstruct(n-1, 3, vp, b);
#endif
}
...
int vna_readcal(int n)
{
  ...
  vp[3] = &tcal;
  b[3] = sizeof(tcal);
  err = readflashstruct(n - 1, 4, vp, b);
#else
  err = readflashstruct(n - 1, 3, vp, b);
#endif
  free_calib_memory();
  return err;
}
...
int vna_calentry(int n, char *s, int len)
{
  ...
  if ((readflashstruct(n - 1, 2, vp, b) != 0) && (rd_flash_header.flash_header_1 == flash_header.flash_header_1) && (rd_flash_header.flash_header_2 == flash_header.flash_header_2))
  {
...
{
  if (!usb_init_mass_storage()) return 0;
  for (;;)
  {
    usb_mass_storage_loop();
  }  
}

int mass_cmd(int args, tinycl_parameter *tp, void *v)
{
  console_println("Entering mass storage mode\r\n");
  delay(2000);
  return vna_mass_storage_device();
}

const tinycl_command tcmds[] =
{
  //  { "J", "Jogwheel=", jogwheel_cmd, TINYCL_PARM_END },
  { "MASS", "Enter mass storage mode", mass_cmd, TINYCL_PARM_END },
